...
<body <?php body_class(); ?>>
	...
	<div class="bsc__header">
		<?php 
			//require get_stylesheet_directory() . '/components/header/header--desktop.php'; 
			//require get_stylesheet_directory() . '/components/header/header--mobile.php'; 
		?>
	</div>
