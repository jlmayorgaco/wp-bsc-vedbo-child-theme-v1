			...
			<p class="form-row validate-required">
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
					...
					<span class="woocommerce-terms-and-conditions-checkbox-text">
						...
						He leído y estoy de acuerdo con los <a href="http://bsc.local/politica-privacidad/" class="woocommerce-terms-and-conditions-link" target="_blank">Terminos y Condiciones</a> de la web
					</span>&nbsp;
