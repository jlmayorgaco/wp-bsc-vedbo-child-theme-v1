	...
	<?php if ( true === WC()->cart->needs_shipping_address() ) : ?>
		...
		<h3 id="ship-to-different-address">
			<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
				...
				class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox"  style=" text-transform: none;"
				<?php checked( apply_filters( 'woocommerce_ship_to_different_address_checked', 'shipping' === get_option( 'woocommerce_ship_to_destination' ) ? 1 : 0 ), 0 ); ?> type="checkbox" name="ship_to_different_address" value="1" /> <span style=" text-transform: none;"><?php esc_html_e( '¿Enviar a otra dirección?', 'woocommerce' ); ?></span>
			</label>
		</h3>
